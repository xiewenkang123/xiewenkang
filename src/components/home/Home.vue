  ...
  <div class="Home">
    ...
    <div class="col-xs-12 col-md-8 col-lg-8" style="padding:0">
      <div class="article_sun">
        ...
        <v-banner v-bind:article_data="article_data" v-bind:page="page" v-bind:sortFlag="sortFlag" v-bind:pageSize="pageSize" v-bind:pageCount="pageCount" />
